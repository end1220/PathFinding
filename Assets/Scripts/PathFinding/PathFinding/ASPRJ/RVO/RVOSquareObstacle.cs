namespace PathFinding.RVO
{
	...
	public class RVOSquareObstacle : RVOObstacle
	{
		...
		private Int2 oldCenter = new Int2(1000, 1000);
		private int oldHeight = 1000;
		private Int2 oldSize = new Int2(1000, 1000);

		protected override bool AreGizmosDirty()
		{
			return center != oldCenter || height != oldHeight || size != oldSize;
		}
